 ...
 */
'use strict';
angular.module('mfcore').factory('MFDataToFileAction', ['$q', 'MFCordova', 'MFBaseAction',
    function($q, MFCordova, MFBaseAction) {
        return {
                ...
                action.doAction = function(context, params) {
                    ...
                    try {
                       $q.when(true).then(function(){
                           return MFCordova.isExistFileSystem();
                       }).then(function(){
                           return MFCordova.isExistFile(params.fileName).then(function(){
                               //supprimer le fichier
                               return MFCordova.deleteFile(params.fileName);
                           },function(){
                               //pas de fichier
                           });
                       }).then(function(){
                           return MFCordova.writeFile(params.fileName, angular.toJson(params.data));
                       }).then(function(){

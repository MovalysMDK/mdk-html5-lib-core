...
angular.module('mfcore').factory('MFInitFillInUserTables',
        ['MFSyncPromiseProvider', 'MFAbstractInitTask', 'MFInitTaskStatus', 'MFSystem',  'MFDalSupport', 'MFDalSqlProxy', 'MFDalNoSqlProxy', 'MFTransactionManager',
         function ($qSync, MFAbstractInitTask, MFInitTaskStatus, MFSystem, MFDalSupport, MFDalSqlProxy, MFDalNoSqlProxy, MFTransactionManager) {
                        ...
                        MFTransactionManager.run(context, function(context, param) {
                            ...
                            for (objectStoreName in response.data) {
                                ...
                                for (var i = 0; i < elements.length; ++i) {
                                    promises.push(MFDalNoSqlProxy.insert(context, objectStoreName, elements[i]));
                                }
                            }

...
angular.module('mfcore').service('MFGenericEnumConverter', ['MFException', '$injector', function (MFException, $injector) {    // instantiated only once, at the startup of the app

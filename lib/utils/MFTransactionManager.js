...
angular.module('mfcore').factory('MFTransactionManager', ['MFDatabaseTypeSelector', 'MFDalSqlProxy', 'MFDalNoSqlProxy', 'MFContextFactory',
    function (MFDatabaseTypeSelector, MFDalSqlProxy, MFDalNoSqlProxy, MFContextFactory) {

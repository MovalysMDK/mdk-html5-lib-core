...
//@non-generated-end
angular.module('data-daotest-sql').factory('ResourceTypeConverter', ['ResourceType', function (ResourceType)
{
...
return  { value: value.value, key: 'enum__' + value._type + '__' + value.key };
};

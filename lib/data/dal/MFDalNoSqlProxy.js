...
angular.module('mfcore').factory('MFDalNoSqlProxy',
    ...
    MFDalNoSqlProxy.prototype.insert= function(context, objectStore, data){

        return this.getPointer().insert(context, objectStore, data);
    };

    MFDalNoSqlProxy.prototype.save = function(context, objectStore, data){

        return this.getPointer().save(context, objectStore, data);
    };

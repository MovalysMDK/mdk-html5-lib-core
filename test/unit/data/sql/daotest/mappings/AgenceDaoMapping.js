...
angular.module('data-daotest-sql').factory('AgenceDaoMapping',
[
...
{leftAttr: 'RUE', rightAttr: 'rue'},
{leftAttr: 'CODEPOSTAL', rightAttr: 'codepostal'},
{leftAttr: 'VILLE', rightAttr: 'ville'},
...
{leftAttr: 'WEBSITE', rightAttr: 'website'},
{leftAttr: 'PHONE', rightAttr: 'phone'},
{leftAttr: 'DECIMAL', rightAttr: 'decimal'},
{leftAttr: 'ACTIVITE4ID', rightAttr: ['activite4', 'id'], rightFactory: 'ActiviteFactory', childIdentifier: true},
{leftAttr: 'DETAILID', rightAttr: ['detail', 'id'], rightFactory: 'AgenceDetailFactory', childIdentifier: true},
{leftAttr: 'ACTIVITE3ID', rightAttr: ['activite3', 'id'], rightFactory: 'ActiviteFactory', childIdentifier: true},
{leftAttr: 'ACTIVITE2ID', rightAttr: ['activite2', 'id'], rightFactory: 'ActiviteFactory', childIdentifier: true},
{leftAttr: 'ACTIVITE1ID', rightAttr: ['activite1', 'id'], rightFactory: 'ActiviteFactory', childIdentifier: true},
{leftAttr: 'MAINCLIENTID', rightAttr: ['mainClient', 'id'], rightFactory: 'ClientFactory', childIdentifier: true}
]
			},

		mappingNoSql: {rightFactory: 'AgenceFactory',
attributes: [
{leftAttr: 'id', rightAttr: 'id', identifier: true},
{leftAttr: 'nom', rightAttr: 'nom'},
{leftAttr: 'rue', rightAttr: 'rue'},

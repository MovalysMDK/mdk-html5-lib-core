...
angular.module('mfcore').factory('MFDalIndexedDBTransaction', function () {
    var MFDalIndexedDBTransaction = function MFDalIndexedDBTransaction (dbConnection) {
        ...
        Object.defineProperties(this, {
            transactionPool: {
                get: function () { return _transactionPool; },
                configurable: false,
                enumerable: false
            },

            objectStores: {
                get: function () { return _objectStores; },
                set: function (value) { _objectStores = value; },
                configurable: false,
                enumerable: false
            },
            ...
            onerror: {
                ...
                set: function (value) { _onError = value; },
                configurable: false,
                enumerable: false
            },
            ...
            oncomplete: {
                ...
                set: function (value) { _onComplete = value; },
                configurable: false,
                enumerable: false
            }
        });

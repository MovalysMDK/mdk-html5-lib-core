                                ...
                                if (children.length > 0) {
                                    if (angular.isArray(parent)) {
                                        ...
                                        for (var childIdx = 0; childIdx < children.length; childIdx++) {
                                            ...
                                            if (angular.isArray(childAttrPointingParent) && childAttrPointingParent.length > 0) {
                                                ...
                                                if (angular.isUndefinedOrNull(childrenByParent[children[childIdx][childDefinition.childAttrPointingParent].id])) {
                                                    childrenByParent[children[childIdx][childDefinition.childAttrPointingParent].id] = [];
                                                }
                                                childrenByParent[children[childIdx][childDefinition.childAttrPointingParent].id].push(children[childIdx]);
                                            }
                                        }

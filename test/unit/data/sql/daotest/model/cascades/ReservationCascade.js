...
angular.module('data-daotest-sql').factory('ReservationCascade', ['MFAbstractEnum', function (MFAbstractEnum)
{


var ReservationCascade = function ReservationCascade() {
this.entityName = 'Reservation'; 
this.foreignEntitiesNames = {RESOURCE: 'resource',EMPLOYE: 'employe'};
 };

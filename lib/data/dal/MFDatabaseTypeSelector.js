...
angular.module('mfcore').factory('MFDatabaseTypeSelector', ['MFIntegerConverter', 'MFConfigurationService', 'MFDeviceInfo','MFException', function (MFIntegerConverter, MFConfigurationService, MFDeviceInfo,MFException) {
    ...
    MFDatabaseTypeSelector.prototype.evaluatePlatform = function () {
        ...
        if(this.selectedDatabase === null){
            ...
            if(Modernizr.indexeddb){
                ...
                throw new MFException('Your browser does not support local database');
            }
        }
    };
    ...
    MFDatabaseTypeSelector.prototype.setSelectedDatabase = function (database) {
        ...
        if(availableDatabasesList.NoSql.indexOf(database) >= 0){
            ...
            throw new MFException(database+'is an unknown type of database');

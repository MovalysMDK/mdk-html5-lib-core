...
angular.module('mfcore').factory('MFDalIndexedDB', ['MFSyncPromiseProvider', 'MFException', 'MFDalIndexedDBTransaction','MFConfigurationService', 'MFIntegerConverter',
                                                    function ($qSync, MFException, MFDalIndexedDBTransaction,MFConfigurationService, MFIntegerConverter) {
    ...
    MFDalIndexedDB.insert = function(context, objectStoreName, data) {
    ...
    MFDalIndexedDB.save = function(context, objectStoreName, data) {
        data = Array.isArray(data) ? data : [data];
